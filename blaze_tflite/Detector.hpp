...
private:
    ...
    std::unique_ptr<tflite::Interpreter> interp_detector;
    TfLiteTensor* in_tensor;
    TfLiteTensor* out_reg_tensor;
    TfLiteTensor* out_clf_tensor;
    TfLiteIntArray *in_dims;
    TfLiteIntArray *out_reg_dims;
    TfLiteIntArray *out_clf_dims;
    ...
    std::vector<int> out_reg_shape;
    std::vector<int> out_clf_shape;
